...
void segment_register_callback_complete(void *segment, seg_callback fn, void *arg);
void segment_register_callback_error(void *segment, seg_callback fn, void *arg);
