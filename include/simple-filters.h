...
struct io_filter_t *create_byte_count_limit_filter(void *alloc, const char *name, uint64_t byte_limit);
struct io_filter_t *create_byte_counter_filter(void *alloc, const char *name, uint64_t bytes_per_sample);
